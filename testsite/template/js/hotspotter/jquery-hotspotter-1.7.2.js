    ...
    $.fn.hotspotter.General = {
        init: function () {
            ...
            if (this.b_$spot.hasClass('img-spot')) {
                ...
                this.spotImgs = [this.b_$spot.find('img').eq(0), this.b_$spot.find('img').eq(1)];
                this.spotImgs[1].hide(); //for ie8

            } else if (this.b_$spot.hasClass('markup-spot')) {

                this.spotMarkup = [this.b_$spot.find('div').eq(0), this.b_$spot.find('div').eq(1)];
                this.spotMarkup[1].hide(); //for ie8
        ...
        enter: function () {
            ...
            if (this.b_$spot.hasClass('img-spot')) {
                ...
                this.spotImgs[0].css('display', 'none');
                this.spotImgs[1].css('display', 'block');

            } else if (this.b_$spot.hasClass('markup-spot')) {

                this.spotMarkup[0].hide();
                this.spotMarkup[1].show();
            ...
            if (this.b_tooltipAnim === 'fade') {
                ...
                switch (this.b_tooltipDir) {
                    case 'top':
                        this.b_$tooltip.css('bottom','125%');
        ...
        leave:function() {
            ...
            if (this.b_$spot.hasClass('img-spot')) {
                this.spotImgs[0].css('display', 'block');
                this.spotImgs[1].css('display', 'none');
            }else if (this.b_$spot.hasClass('markup-spot')) {
                this.spotMarkup[0].show();
                this.spotMarkup[1].hide();
            }else{
